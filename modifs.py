...
def update_graph_rea_tps(title):
    fig_tps = px.line(evol_rea, x=evol_rea['date'], y=evol_rea['rea'], title=title,
        labels={"date":"Date","rea":"Nombre de réanimations"})
...
def update_graph_rea_age(title):
    fig_age = px.bar(age_rea, x=age_rea['cl_age90_str'], y=age_rea['rea'], title=title, text=age_rea['rea'],
        labels={"cl_age90_str":"Classe d'âge","rea":"Nombre de réanimations"})
...
def update_graph_rea_sexe(title):
    fig_sexe = px.bar(sexe_rea, x=sexe_rea['sexe_str'], y=sexe_rea['rea'], title=title, text=sexe_rea['rea'],
        labels={"sexe_str":"Sexe","rea":"Nombre de réanimations"})
...
def update_graph_rea_reg(title):
    fig_reg = px.bar(reg_rea, x=reg_rea['reg_str'], y=reg_rea['rea'], title=title, text=reg_rea['rea'],
        labels={"reg_str":"Régions","rea":"Nombre de réanimations"})
...
def update_graph_rea_dep(title):
    fig_dep = px.bar(dep_rea_new, x=dep_rea_new['dep_str'], y=dep_rea_new['rea'], title=title, text=dep_rea_new['rea'],
        labels={"dep_str":"Départements","rea":"Nombre de réanimations"})
...
def update_graph_dc_tps(title):
    fig_tps_dc = px.line(evol_dc, x=evol_dc['date'], y=evol_dc['dc'], title=title,
        labels={"date":"Date","dc":"Nombre de décès"})
...
def update_graph_dc_age(title):
    fig_age_dc = px.bar(age_dc, x=age_dc['cl_age90_str'], y=age_dc['dc'], title=title, text=age_dc['dc'],
        labels={"cl_age90_str":"Classe d'âge","dc":"Nombre de décès"})
...
def update_graph_dc_sexe(title):
    fig_dc_sexe = px.bar(sexe_dc, x=sexe_dc['sexe_str'], y=sexe_dc['dc'], title=title, text=sexe_dc['dc'],
        labels={"sexe_str":"Sexe","dc":"Nombre de décès"})
...
def update_graph_dc_reg(title):
    fig_dc_reg = px.bar(reg_dc, x=reg_dc['reg_str'], y=reg_dc['dc'], title=title, text=reg_dc['dc'],
        labels={"reg_str":"Régions","dc":"Nombre de décès"})
...
def update_graph_dc_dep(title):
    fig_dep_dc = px.bar(dep_dc_new, x=dep_dc_new['dep_str'], y=dep_dc_new['dc'], title=title, text=dep_dc_new['dc'],
        labels={"dep_str":"Départements","dc":"Nombre de décès"})
...
def update_graph_dose1(title):
    fig1 = px.line(evol, x=evol['date'], y=evol['n_dose1'], title=title,
        labels={"date":"Date","n_dose1":"Nombre de vaccinations Dose1"})
...
def update_graph_dose2(title):
    fig2 = px.line(evol2, x=evol2['date'], y=evol2['n_dose2'],title=title,
        labels={"date":"Date","n_dose2":"Nombre de vaccinations Dose 2"})
...
def update_graph_dose_cum1(title):
    fig3 = px.line(evol_cum, x=evol_cum['date'], y=evol_cum['n_cum_dose1'], title=title,
        labels={"date":"Date","n_cum_dose1":"Nombre de vaccinations Dose1"})
...
def update_graph_dose_cum1(title):
    fig4 = px.line(evol_cum2, x=evol_cum2['date'], y=evol_cum2['n_cum_dose2'], title=title,
        labels={"date":"Date","n_cum_dose2":"Nombre de vaccinations Dose 2"})
...
def update_graph_age(title):
    fig = px.bar(evol_age, x=evol_age['classe_age'], y=evol_age['n_complet'], title=title,
        labels={"classe_age":"Classe d'âge","n_complet":"Nombre de vaccinations complètes"})
...
def update_graph_reg(title):
    fig5 = px.bar(evol_reg, x=evol_reg['region'],y=evol_reg['n_complet'], title=title, text=evol_reg['n_complet'],
        labels={"region":"Région","n_complet":"Nombre de vaccinations complètes"})
